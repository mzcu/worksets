...
class StrengthIntro4Day(implicit private val workoutHistory: WorkoutHistory) extends WorkoutGenerator {
  ...
  private val sixToEightRange = 6 to 8

  private val squatDay: WorkoutDay = { date =>
    (
      workout on date
        exercise CompetitionSquat worksetByE1RM 85.pct x 1 worksetRelative 90.pct x 4 sets 3
        exercise CompetitionBench worksetByE1RM 78.pct x 3 loadDrop 3
        exercise WideGripBench worksetByE1RM 72.pct x 6 repeat 2
      )
  }
  ...
  private val deadLiftDay: WorkoutDay = { date =>
    (
      workout on date
        exercise CompetitionDeadlift worksetByE1RM 90.pct x 1 worksetRelative 90.pct x 3 sets 3
